    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("perfil", models.CharField(choices=[("admin", "Administrador"), ("gerente", "Gerente"), ("atendente", "Atendente"), ("financeiro", "Financeiro"), ("readonly", "Somente leitura")], default="atendente", max_length=20)),
