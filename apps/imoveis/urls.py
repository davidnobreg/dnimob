...
urlpatterns = [
    ...
    path('proprietarios/',                      views.proprietario_lista,  name='proprietario_lista'),
    path('proprietarios/novo/',                 views.proprietario_criar,  name='proprietario_criar'),
    path('proprietarios/<int:pk>/editar/',      views.proprietario_editar, name='proprietario_editar'),
